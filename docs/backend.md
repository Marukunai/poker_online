...
4. [Requisitos y configuración](-requisitos-y-configuracion)
5. [Inicio de la aplicación](-inicio-de-la-aplicacion)
6. [Autenticación y seguridad](-autenticacion-y-seguridad)
...
10. [WebSocket: comunicación en tiempo real](-websocket-comunicacion-en-tiempo-real)
...
15. [Estadísticas y ranking](-estadisticas-y-ranking)
